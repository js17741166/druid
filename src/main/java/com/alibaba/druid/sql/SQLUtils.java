...
public class SQLUtils {
    ...
    public static String toImpalaString(SQLObject sqlObject) {
        return toImpalaString(sqlObject, (FormatOption) null);
    }
    ...
    public static String toImpalaString(SQLObject sqlObject, FormatOption option) {
        return toSQLString(sqlObject, JdbcConstants.IMPALA, option);
    }
    ...
    public static String formatImpala(String sql, FormatOption option) {
        return format(sql, JdbcConstants.IMPALA, option);
    }
