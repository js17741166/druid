...
public class ImpalaExportParameterVisitor extends ImpalaOutputVisitor implements ExportParameterVisitor {
    ...
    public ImpalaExportParameterVisitor(List<Object> parameters, Appendable appender, boolean wantParameterizedOutput){
        super(appender, true);
        this.parameters = parameters;
        this.requireParameterizedOutput = wantParameterizedOutput;
    }

    public ImpalaExportParameterVisitor() {
        this(new ArrayList<Object>());
    }

    public ImpalaExportParameterVisitor(List<Object> parameters) {
        this(parameters, null, false);
    }

    public ImpalaExportParameterVisitor(final Appendable appender) {
