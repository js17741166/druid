...
import com.alibaba.druid.sql.dialect.impala.ast.ImpalaObject;
...
public class ImpalaSelectQueryBlock extends SQLSelectQueryBlock implements ImpalaObject {
    ...
    public ImpalaSelectQueryBlock(){
        dbType = JdbcConstants.IMPALA;
    }

    public ImpalaSelectQueryBlock clone() {
        ImpalaSelectQueryBlock x = new ImpalaSelectQueryBlock();
        cloneTo(x);
    ...
    public boolean equals(Object obj) {
        ...
        ImpalaSelectQueryBlock other = (ImpalaSelectQueryBlock) obj;
    ...
    public String toString() {
        return SQLUtils.toImpalaString(this);
    }
}
