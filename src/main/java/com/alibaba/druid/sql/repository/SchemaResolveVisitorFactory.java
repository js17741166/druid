...
import com.alibaba.druid.sql.dialect.impala.visitor.ImpalaASTVisitorAdapter;
...
class SchemaResolveVisitorFactory {
    ...
    static class ImpalaResolveVisitor extends ImpalaASTVisitorAdapter implements SchemaResolveVisitor {
        private int options;
        private SchemaRepository repository;
        private Context context;

        public ImpalaResolveVisitor(SchemaRepository repository, int options) {
            this.repository = repository;
            this.options = options;
        }
